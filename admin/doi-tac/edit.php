...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form action="<?= $adminUrl ?>doi-tac/save-edit.php" method="post" enctype="multipart/form-data" id="form">
      <div class="row">
        <div class="col-md-6">
          <input type="hidden" name="id" value="<?= $id ?>">
            ...
            <div class="col-md-offset-3">
              <img  id="imageTarget" width="70%" src="<?= $siteUrl ?><?= $brand['image'] ?>" class="img-reponsive">
            </div>
          </div>
          <div class="form-group">
              <label>Ảnh</label>
              <input id="brand_image" type="file" name="image" class="form-control">
            </div>
            <div class="col-md-12">
