<script src="./dist/js/jquery-1.11.3.min.js" type="text/javascript"></script>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:150px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:150px;overflow:hidden;">
            <div>
                <img data-u="image" src="./public/img/01.png" />
            </div>
            <div>
                <img data-u="image" src="./public/img/02.png" />
            </div>
            <div>
                <img data-u="image" src="./public/img/03.png" />
            </div>
            <div>
                <img data-u="image" src="./public/img/04.png" />
            </div>
            <div>
                <img data-u="image" src="./public/img/05.png" />
            </div>
            <div>
                <img data-u="image" src="./public/img/06.png" />
            </div>
            <div>
                <img data-u="image" src="./public/img/01.png" />
            </div>
